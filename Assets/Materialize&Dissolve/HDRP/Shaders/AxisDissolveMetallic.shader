	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 VertexOffset252 = ( lerpResult92_g20 * inputMesh.normalOS );
						...
						)
			{
				...
				float2 uv_MainTex255 = packedInput.ase_texcoord5.xy;
				...
				float2 uv_BumpMap274 = packedInput.ase_texcoord5.xy;
				float3 TangentNormal264 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap274 ), 1.0f );
				
				float2 uv_MetallicTexture267 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode267 = tex2D( _MetallicTexture, uv_MetallicTexture267 );
				float MetallicValue261 = ( tex2DNode267.r * _MetallicValue );
				
				float2 uv_EmissionMap270 = packedInput.ase_texcoord5.xy;
				float4 EmissionColor272 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap270 ) * _EmissionColor * _EmissionIntesity ) : float4( 0,0,0,0 ) );
				...
				float2 uv_OcclusionMap1275 = packedInput.ase_texcoord5.xy;
				...
				surfaceDescription.BaseColor = Albedo213.rgb;
				surfaceDescription.Normal = TangentNormal264;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = MetallicValue261;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = ( EmissionColor272 + ( DissolveEmission238 * _DissolveEmissionIntesity ) ).rgb;
				surfaceDescription.Smoothness = SmoothnessValue283;
				surfaceDescription.Occlusion = OcclusionMap277;
				surfaceDescription.Alpha = DissolveAlpha214;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MainTex255 = packedInput.ase_texcoord.xy;
				float4 tex2DNode255 = tex2D( _MainTex, uv_MainTex255 );
				float4 AlbedoColor259 = ( tex2DNode255 * _Color );
				float4 temp_output_101_0_g20 = AlbedoColor259;
				float DissolveAmount13_g20 = _DissolveAmount;
				...
				float2 uv_BumpMap274 = packedInput.ase_texcoord.xy;
				float3 TangentNormal264 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap274 ), 1.0f );
				
				float2 uv_MetallicTexture267 = packedInput.ase_texcoord.xy;
				float4 tex2DNode267 = tex2D( _MetallicTexture, uv_MetallicTexture267 );
				float MetallicValue261 = ( tex2DNode267.r * _MetallicValue );
				
				float2 uv_EmissionMap270 = packedInput.ase_texcoord.xy;
				float4 EmissionColor272 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap270 ) * _EmissionColor * _EmissionIntesity ) : float4( 0,0,0,0 ) );
				float4 DissolveEmission238 = EmissionColor109_g20;
				...
				float2 uv_OcclusionMap1275 = packedInput.ase_texcoord.xy;
				float OcclusionMap277 = tex2D( _OcclusionMap1, uv_OcclusionMap1275 ).r;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_BumpMap274 = packedInput.ase_texcoord3.xy;
				float3 TangentNormal264 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap274 ), 1.0f );
				
				float2 uv_MetallicTexture267 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode267 = tex2D( _MetallicTexture, uv_MetallicTexture267 );
				float2 uv_MainTex255 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode255 = tex2D( _MainTex, uv_MainTex255 );
				#if defined(_GLOSSSOURCE_ALBEDOALPHA)
				float staticSwitch282 = tex2DNode255.a;
				#elif defined(_GLOSSSOURCE_METALLICALPHA)
...
/*ASEBEGIN
Version=19002
202;73;1150;616;-605.618;-748.1543;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;254;-489.8708,591.688;Inherit;False;1242.73;2053.751;;27;283;282;281;280;279;278;277;275;274;273;272;271;270;269;268;267;265;264;263;262;261;260;259;257;256;255;298;Standard Metallic Inputs;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;209;-166.077,-51.38562;Inherit;False;1010;443;;6;213;238;211;214;252;212;Dissolve Function;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;299;975.618,910.1543;Inherit;False;Property;_DissolveEmissionIntesity;Dissolve Emission Intesity;13;0;Create;True;0;0;0;False;0;False;1000;1000;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;298;-26.43848,2240.415;Inherit;False;Property;_EmissionIntesity;Emission Intesity;12;0;Create;True;0;0;0;False;0;False;1000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;243;1202.18,1095.701;Inherit;False;283;SmoothnessValue;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;240;1226.93,1036.753;Inherit;False;261;MetallicValue;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;248;1306.487,1337.828;Inherit;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;225;1249.93,1248.753;Inherit;False;214;DissolveAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;253;1318.053,1405.798;Inherit;False;252;VertexOffset;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;223;1229.93,1152.753;Inherit;False;277;OcclusionMap;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;251;1028.134,824.9283;Inherit;False;238;DissolveEmission;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;263;-59.01677,2109.825;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;212;144.2479,85.27469;Inherit;False;AxisDissolve;14;;20;c7e8d1367c6e85c468a8796d0ba1e1a6;0;1;101;COLOR;1,1,1,1;False;4;COLOR;100;COLOR;102;FLOAT3;98;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;300;1247.618,909.1543;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;255;-439.8708,1072.75;Inherit;True;Property;_MainTex;Albedo;0;2;[NoScaleOffset];[SingleLineTexture];Create;False;1;PBR Settings;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;247;1;300;0
WireConnection;269;0;271;3
WireConnection;271;0;259;0
WireConnection;300;0;251;0
...
WireConnection;285;0;239;0
WireConnection;285;1;246;0
WireConnection;285;4;240;0
WireConnection;285;6;247;0
WireConnection;285;7;243;0
WireConnection;285;8;223;0
WireConnection;285;9;225;0
WireConnection;285;10;248;0
WireConnection;285;11;253;0
ASEEND*/
//CHKSM=588E80E95F077F7EB0AA7578379F10694E919409