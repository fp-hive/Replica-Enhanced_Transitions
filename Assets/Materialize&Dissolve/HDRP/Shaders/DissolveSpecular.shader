...
Shader "DissolveSpecular"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			inline float4 TriplanarSampling20_g2( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
						...
						)
			{
				...
				float2 uv_MainTex153 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode153 = tex2D( _MainTex, uv_MainTex153 );
				float4 AlbedoColor158 = ( tex2DNode153 * _Color );
				
				float2 uv_BumpMap169 = packedInput.ase_texcoord5.xy;
				float3 TangentNormal174 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap169 ), 1.0f );
				
				float2 uv_SpecGlossMap156 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode156 = tex2D( _SpecGlossMap, uv_SpecGlossMap156 );
				float4 SpecularColor171 = ( tex2DNode156.r * _SpecColor );
				
				float2 uv_EmissionMap150 = packedInput.ase_texcoord5.xy;
				float4 EmissionColor164 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap150 ) * _EmissionColor * _EmissionIntesity ) : float4( 0,0,0,0 ) );
				float2 uv_GuideTexture = packedInput.ase_texcoord5.xy * _GuideTexture_ST.xy + _GuideTexture_ST.zw;
				float2 temp_cast_2 = (_UVTilingTriplanar).xx;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar20_g2 = TriplanarSampling20_g2( _GuideTexture, ase_worldPos, normalWS, 1.0, temp_cast_2, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g2 = triplanar20_g2.x;
				#else
				float staticSwitch24_g2 = tex2D( _GuideTexture, uv_GuideTexture ).r;
				#endif
				float temp_output_9_0_g2 = ( staticSwitch24_g2 * _GuideAdjuster );
				float DissolveAmount11_g2 = _DissolveAmount;
				float4 lerpResult13_g2 = lerp( float4( 0,0,0,0 ) , _DissolveColor , step( temp_output_9_0_g2 , DissolveAmount11_g2 ));
				float temp_output_6_0_g2 = ( temp_output_9_0_g2 <= (0.0 + (( DissolveAmount11_g2 - _EdgeWidth ) - 0.0) * (1.0 - 0.0) / (( 1.0 - _EdgeWidth ) - 0.0)) ? 0.0 : 1.0 );
				float4 DissolveEmission129 = ( lerpResult13_g2 * temp_output_6_0_g2 );
				...
				float2 uv_OcclusionMap166 = packedInput.ase_texcoord5.xy;
				float OcclusionMap170 = tex2D( _OcclusionMap, uv_OcclusionMap166 ).r;
				
				float DissolveAlpha125 = temp_output_6_0_g2;
				
				surfaceDescription.BaseColor = AlbedoColor158.rgb;
				surfaceDescription.Normal = TangentNormal174;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = SpecularColor171.rgb;
				#endif

				surfaceDescription.Emission = ( EmissionColor164 + ( DissolveEmission129 * _DissolveEmissionIntesity ) ).rgb;
				surfaceDescription.Smoothness = SmoothnessValue176;
				surfaceDescription.Occlusion = OcclusionMap170;
				surfaceDescription.Alpha = DissolveAlpha125;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MainTex153 = packedInput.ase_texcoord.xy;
				float4 tex2DNode153 = tex2D( _MainTex, uv_MainTex153 );
				float4 AlbedoColor158 = ( tex2DNode153 * _Color );
				
				float2 uv_BumpMap169 = packedInput.ase_texcoord.xy;
				float3 TangentNormal174 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap169 ), 1.0f );
				
				float2 uv_SpecGlossMap156 = packedInput.ase_texcoord.xy;
				float4 tex2DNode156 = tex2D( _SpecGlossMap, uv_SpecGlossMap156 );
				float4 SpecularColor171 = ( tex2DNode156.r * _SpecColor );
				
				float2 uv_EmissionMap150 = packedInput.ase_texcoord.xy;
				float4 EmissionColor164 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap150 ) * _EmissionColor * _EmissionIntesity ) : float4( 0,0,0,0 ) );
				...
				float4 triplanar20_g2 = TriplanarSampling20_g2( _GuideTexture, ase_worldPos, ase_worldNormal, 1.0, temp_cast_2, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g2 = triplanar20_g2.x;
				#else
				float staticSwitch24_g2 = tex2D( _GuideTexture, uv_GuideTexture ).r;
				...
				float2 uv_OcclusionMap166 = packedInput.ase_texcoord.xy;
				float OcclusionMap170 = tex2D( _OcclusionMap, uv_OcclusionMap166 ).r;
		...
		Pass
		{
					...
					)
			{
				...
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 ase_worldNormal = packedInput.ase_texcoord2.xyz;
				float4 triplanar20_g2 = TriplanarSampling20_g2( _GuideTexture, ase_worldPos, ase_worldNormal, 1.0, temp_cast_0, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g2 = triplanar20_g2.x;
				#else
				float staticSwitch24_g2 = tex2D( _GuideTexture, uv_GuideTexture ).r;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_BumpMap169 = packedInput.ase_texcoord3.xy;
				float3 TangentNormal174 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap169 ), 1.0f );
				
				float2 uv_SpecGlossMap156 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode156 = tex2D( _SpecGlossMap, uv_SpecGlossMap156 );
				float2 uv_MainTex153 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode153 = tex2D( _MainTex, uv_MainTex153 );
				#if defined(_GLOSSSOURCE1_ALBEDOALPHA)
				float staticSwitch160 = tex2DNode153.a;
				#elif defined(_GLOSSSOURCE1_SPECULARALPHA)
				...
				float2 temp_cast_0 = (_UVTilingTriplanar).xx;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar20_g2 = TriplanarSampling20_g2( _GuideTexture, ase_worldPos, normalWS, 1.0, temp_cast_0, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g2 = triplanar20_g2.x;
				#else
				float staticSwitch24_g2 = tex2D( _GuideTexture, uv_GuideTexture ).r;
...
/*ASEBEGIN
Version=19002
202;73;1150;616;-2954.142;1048.768;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;149;1623.593,-1127.853;Inherit;False;1242.73;2053.751;;28;176;175;174;173;172;171;170;169;168;167;166;165;164;163;162;161;160;159;158;157;156;155;154;153;152;151;150;196;Standard Inputs;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;155;2054.447,390.2829;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;180;2117.964,-1521.887;Inherit;False;Dissolve;16;;2;8b95cf011869c504193c0700bdb62ebb;0;0;2;COLOR;15;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;198;3549.142,-762.7683;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;159;1783.144,-33.7209;Inherit;False;Property;_SpecColor;Specular Value;5;0;Create;False;0;0;0;True;0;False;0.6226415,0.6226415,0.6226415,0;0.6226415,0.6226415,0.6226415,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;144;3445.394,-368.9083;Inherit;False;170;OcclusionMap;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;197;3307.142,-721.7683;Inherit;False;Property;_DissolveEmissionIntesity;Dissolve Emission Intesity;15;0;Create;True;0;0;0;False;0;False;1000;1000;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;178;2395.333,660.2099;Inherit;False;Property;_Float2;Float 2;0;1;[HideInInspector];Create;True;0;0;0;True;3;Foldout(Main,true,8);;Space;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;146;3916.777,-482.9114;Inherit;False;Property;_AdvancedInpector;AdvancedInpector;24;1;[HideInInspector];Create;True;0;0;0;True;2;;DrawSystemProperties;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;181;3724.971,-161.1321;Inherit;False;Constant;_Float3;Float 3;16;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;145;3682.531,-1034.373;Inherit;False;158;AlbedoColor;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;177;2602.779,655.522;Inherit;False;Property;_Float1;Float 1;14;1;[HideInInspector];Create;True;0;0;0;True;2;Space;EndGroup();False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;139;3310.704,-818.6229;Inherit;False;129;DissolveEmission;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;196;2074.521,538.4572;Inherit;False;Property;_EmissionIntesity;Emission Intesity;13;0;Create;True;0;0;0;False;0;False;1000;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;141;3416.807,-459.9415;Inherit;False;176;SmoothnessValue;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;132;3535.725,-214.0328;Inherit;False;125;DissolveAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;142;3466.466,-544.1329;Inherit;False;171;SpecularColor;1;0;OBJECT;;False;1;COLOR;0
...
WireConnection;147;1;198;0
WireConnection;183;0;145;0
WireConnection;183;1;148;0
WireConnection;183;5;142;0
WireConnection;183;6;147;0
WireConnection;183;7;141;0
WireConnection;183;8;144;0
WireConnection;183;9;132;0
WireConnection;183;10;181;0
ASEEND*/
//CHKSM=FF2E38A39B072ADF1A52F67DA40E382E6FF8DFA8