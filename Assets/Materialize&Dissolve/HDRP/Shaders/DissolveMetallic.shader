...
Shader "DissolveMetallic"
{
	Properties
	{
		...
		[Header(Dissolve Settings)][Space]_DissolveAmount("Dissolve Amount", Range( 0 , 1)) = 0.3801628
		...
		[ASEEnd]_UVTilingTriplanar("UV Tiling Triplanar", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			inline float4 TriplanarSampling20_g6( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
						...
						)
			{
				...
				float2 uv_MainTex68 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode68 = tex2D( _MainTex, uv_MainTex68 );
				float4 AlbedoColor75 = ( tex2DNode68 * _Color );
				
				float2 uv_BumpMap82 = packedInput.ase_texcoord5.xy;
				float3 TangentNormal87 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap82 ), 1.0f );
				
				float2 uv_MetallicTexture72 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode72 = tex2D( _MetallicTexture, uv_MetallicTexture72 );
				float MetallicValue89 = ( tex2DNode72.r * _MetallicValue );
				
				float2 uv_EmissionMap65 = packedInput.ase_texcoord5.xy;
				float4 EmissionColor80 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap65 ) * _EmissionColor * _EmissionIntesity ) : float4( 0,0,0,0 ) );
				float2 uv_GuideTexture = packedInput.ase_texcoord5.xy * _GuideTexture_ST.xy + _GuideTexture_ST.zw;
				float2 temp_cast_1 = (_UVTilingTriplanar).xx;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar20_g6 = TriplanarSampling20_g6( _GuideTexture, ase_worldPos, normalWS, 1.0, temp_cast_1, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g6 = triplanar20_g6.x;
				#else
				float staticSwitch24_g6 = tex2D( _GuideTexture, uv_GuideTexture ).r;
				#endif
				float temp_output_9_0_g6 = ( staticSwitch24_g6 * _GuideAdjuster );
				float DissolveAmount11_g6 = _DissolveAmount;
				float4 lerpResult13_g6 = lerp( float4( 0,0,0,0 ) , _DissolveColor , step( temp_output_9_0_g6 , DissolveAmount11_g6 ));
				float temp_output_6_0_g6 = ( temp_output_9_0_g6 <= (0.0 + (( DissolveAmount11_g6 - _EdgeWidth ) - 0.0) * (1.0 - 0.0) / (( 1.0 - _EdgeWidth ) - 0.0)) ? 0.0 : 1.0 );
				float4 DissolveEmission105 = ( lerpResult13_g6 * temp_output_6_0_g6 );
				...
				float2 uv_OcclusionMap183 = packedInput.ase_texcoord5.xy;
				float OcclusionMap85 = tex2D( _OcclusionMap1, uv_OcclusionMap183 ).r;
				
				float DissolveAlpha106 = temp_output_6_0_g6;
				
				surfaceDescription.BaseColor = AlbedoColor75.rgb;
				surfaceDescription.Normal = TangentNormal87;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = MetallicValue89;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = ( EmissionColor80 + ( DissolveEmission105 * _DissolveEmissionIntesity ) ).rgb;
				surfaceDescription.Smoothness = SmoothnessValue88;
				surfaceDescription.Occlusion = OcclusionMap85;
				surfaceDescription.Alpha = DissolveAlpha106;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MainTex68 = packedInput.ase_texcoord.xy;
				float4 tex2DNode68 = tex2D( _MainTex, uv_MainTex68 );
				float4 AlbedoColor75 = ( tex2DNode68 * _Color );
				
				float2 uv_BumpMap82 = packedInput.ase_texcoord.xy;
				float3 TangentNormal87 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap82 ), 1.0f );
				
				float2 uv_MetallicTexture72 = packedInput.ase_texcoord.xy;
				float4 tex2DNode72 = tex2D( _MetallicTexture, uv_MetallicTexture72 );
				float MetallicValue89 = ( tex2DNode72.r * _MetallicValue );
				
				float2 uv_EmissionMap65 = packedInput.ase_texcoord.xy;
				float4 EmissionColor80 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap65 ) * _EmissionColor * _EmissionIntesity ) : float4( 0,0,0,0 ) );
				float2 uv_GuideTexture = packedInput.ase_texcoord.xy * _GuideTexture_ST.xy + _GuideTexture_ST.zw;
				float2 temp_cast_1 = (_UVTilingTriplanar).xx;
				float3 ase_worldPos = packedInput.ase_texcoord1.xyz;
				float3 ase_worldNormal = packedInput.ase_texcoord2.xyz;
				float4 triplanar20_g6 = TriplanarSampling20_g6( _GuideTexture, ase_worldPos, ase_worldNormal, 1.0, temp_cast_1, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g6 = triplanar20_g6.x;
				#else
				float staticSwitch24_g6 = tex2D( _GuideTexture, uv_GuideTexture ).r;
				...
				float2 uv_OcclusionMap183 = packedInput.ase_texcoord.xy;
				float OcclusionMap85 = tex2D( _OcclusionMap1, uv_OcclusionMap183 ).r;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_GuideTexture = packedInput.ase_texcoord1.xy * _GuideTexture_ST.xy + _GuideTexture_ST.zw;
				float2 temp_cast_0 = (_UVTilingTriplanar).xx;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 ase_worldNormal = packedInput.ase_texcoord2.xyz;
				float4 triplanar20_g6 = TriplanarSampling20_g6( _GuideTexture, ase_worldPos, ase_worldNormal, 1.0, temp_cast_0, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g6 = triplanar20_g6.x;
				#else
				float staticSwitch24_g6 = tex2D( _GuideTexture, uv_GuideTexture ).r;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_BumpMap82 = packedInput.ase_texcoord3.xy;
				float3 TangentNormal87 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap82 ), 1.0f );
				
				float2 uv_MetallicTexture72 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode72 = tex2D( _MetallicTexture, uv_MetallicTexture72 );
				float2 uv_MainTex68 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode68 = tex2D( _MainTex, uv_MainTex68 );
				#if defined(_GLOSSSOURCE_ALBEDOALPHA)
				float staticSwitch76 = tex2DNode68.a;
				#elif defined(_GLOSSSOURCE_METALLICALPHA)
				...
				float2 uv_GuideTexture = packedInput.ase_texcoord3.xy * _GuideTexture_ST.xy + _GuideTexture_ST.zw;
				float2 temp_cast_0 = (_UVTilingTriplanar).xx;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar20_g6 = TriplanarSampling20_g6( _GuideTexture, ase_worldPos, normalWS, 1.0, temp_cast_0, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g6 = triplanar20_g6.x;
				#else
				float staticSwitch24_g6 = tex2D( _GuideTexture, uv_GuideTexture ).r;
...
/*ASEBEGIN
Version=19002
202;73;1150;616;-2311.244;150.852;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;64;1049.135,-288.623;Inherit;False;1242.73;2053.751;;28;91;90;89;88;87;86;85;84;83;82;81;80;79;78;77;76;75;74;73;72;71;70;69;68;67;66;65;141;Standard Metallic Inputs;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;92;1820.874,1499.441;Inherit;False;Property;_EditorStart;Editor Start;0;1;[HideInInspector];Create;True;0;0;0;True;3;Foldout(Main,true,8);;Space;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;84;1142.337,-0.2952223;Inherit;False;Property;_Cutoff;Alpha Clip Threshold;2;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;102;3470.742,396.8288;Inherit;False;Property;_AdvancedInpector;AdvancedInpector;24;1;[HideInInspector];Create;True;0;0;0;True;2;;DrawSystemProperties;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;103;3127.973,-283.6022;Inherit;False;75;AlbedoColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;93;2028.32,1494.753;Inherit;False;Property;_EditorEnd;Editor End;14;1;[HideInInspector];Create;True;0;0;0;True;2;Space;EndGroup();False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;90;1440.538,-8.255211;Inherit;False;AlphaClipThreshold;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;141;1506.699,1393.764;Inherit;False;Property;_EmissionIntesity;Emission Intesity;12;0;Create;True;0;0;0;False;0;False;1000;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;104;2874.003,419.1236;Inherit;False;85;OcclusionMap;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;100;2924.519,240.6378;Inherit;False;89;MetallicValue;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;99;3030.485,504.0813;Inherit;False;106;DissolveAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;97;2876.249,324.8293;Inherit;False;88;SmoothnessValue;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;94;2753.146,-52.85216;Inherit;False;105;DissolveEmission;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;142;2697.244,30.14801;Inherit;False;Property;_DissolveEmissionIntesity;Dissolve Emission Intesity;15;0;Create;True;0;0;0;False;0;False;1000;1000;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;123;3164.752,388.4276;Inherit;False;Constant;_Float0;Float 0;18;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;65;1168.325,1095.095;Inherit;True;Property;_EmissionMap;Emission Texture;11;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;66;1213.816,1286.529;Inherit;False;Property;_EmissionColor;Emission Color;13;1;[HDR];Create;True;0;0;0;True;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;68;1099.135,192.439;Inherit;True;Property;_MainTex;Albedo;1;2;[NoScaleOffset];[SingleLineTexture];Create;False;1;PBR Settings;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;71;1556.363,1099.604;Inherit;False;Property;_UseEmission;UseEmission;10;1;[Toggle];Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;72;1166.882,641.3582;Inherit;True;Property;_MetallicTexture;Metallic Texture;4;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;69;1479.989,1229.514;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;67;1129.746,383.8622;Inherit;False;Property;_Color;Color;3;0;Create;True;0;0;0;True;0;False;1,1,1,1;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;143;2991.244,8.14801;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;74;1365.549,887.8141;Inherit;False;Property;_MetallicValue;Metallic Value;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;126;1568.406,-778.1167;Inherit;False;Dissolve;16;;6;8b95cf011869c504193c0700bdb62ebb;0;0;2;COLOR;15;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;83;1175.531,-238.6229;Inherit;True;Property;_OcclusionMap1;Occlusion Map;9;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;128;1;96;0
WireConnection;128;4;100;0
WireConnection;128;6;98;0
WireConnection;128;7;97;0
WireConnection;128;8;104;0
WireConnection;128;9;99;0
WireConnection;128;10;123;0
ASEEND*/
//CHKSM=C4711300D396DD51A92AB74BB7264EA026DC303C